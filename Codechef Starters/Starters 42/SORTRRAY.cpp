...
// URL: https://www.codechef.com/START42B/problems/SORTRRAY
// Memory Limit: 256 MB
// Time Limit: 2000 ms
// Problem tag: algorithm, important
// TC: O(t*n)
// SC: O(n)
...
void solve()
{
	...
	// increment by powers of 2, maximum 18 bits <20m operations
	map <ll,vll> bits;
	for (ll b=0;b<20;b++)
	{
		ll x=(1LL<<b);
