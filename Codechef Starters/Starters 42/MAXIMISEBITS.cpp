...
// Problem: Maximise Set Bits 
// Contest: CodeChef - Starters 42 Division 2 (Rated)
// URL: https://www.codechef.com/START42B/problems/MAXIMISEBITS
// Memory Limit: 256 MB
// Time Limit: 1000 ms
// Problem tag: bitwise
// TC: O(t*30)
...
void shift(ll b1, ll b2, vll &bit, ll &n)
{
	if (b1==0)
		return;
	ll avail=n-bit[b2];
	ll max_transfer=avail/2;
	ll transfer=min(max_transfer,bit[b1]);
	if (transfer)
		ok=false;
	bit[b1]-=transfer;
	bit[b2]+=transfer*2;
