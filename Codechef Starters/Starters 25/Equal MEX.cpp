...
// Problem: Equal MEX
// Contest: CodeChef - CodeChef Starters 25 Division 2 (Rated)
// URL: https://www.codechef.com/START25B/problems/EQUALMEX
// Memory Limit: 256 MB
// Time Limit: 1000 ms
// Problem tag: easy, map
// TC:
// SC:
...
void solve()
{
	...
	for (ll i=0;i<=N;i++)
	{
		if (mp.find(i)==mp.end()) { YY; return; }
		else if (mp[i]==1) { NN; return; }
	}	
}
